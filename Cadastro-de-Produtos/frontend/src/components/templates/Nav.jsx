...
export default props =>
    <nav className="nav bg-blue-600 text-white">
        <Link to="/" className="flex flex-column w-full items-center justify-center mt-10 p-2 hover:bg-blue-800">
            <i className="mr-2">
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" /></svg>
            </i> Início
        </Link>
        <Link to="/products" className="flex flex-column w-full items-center justify-center p-2 hover:bg-blue-800">
            <i className="mr-2">
        ...
        <Link to="/products/add" className="flex flex-column w-full items-center justify-center p-2 hover:bg-blue-800">
            <i className="mr-2">
